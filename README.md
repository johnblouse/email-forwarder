...
[![Deploy to Cloudflare Workers](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/ame49909-bot/email-forwarder)

点击上方按钮即可一键部署到您的 Cloudflare 账号。
...
```bash
# 克隆仓库
git clone https://github.com/ame49909-bot/email-forwarder.git
cd email-forwarder
